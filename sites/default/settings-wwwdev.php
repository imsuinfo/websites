...
$databases['default'] = $databases['wwwdev'];
unset($dbp);
...
if (isset($_SERVER['SERVER_PORT']) && $_SERVER['SERVER_PORT'] == 443) {
  $base_url = 'https://wwwdev.mcneese.edu';  // NO trailing slash!
}
else {
  $base_url = 'http://wwwdev.mcneese.edu';  // NO trailing slash!
}
...
$conf['ip_php_ini']['include_path'] = array('127.0.0.1' => '/var/www/drupal/wwwdev:/usr/local/lib/php');
...
$conf['error_document_file_503'] = '/var/www/error_documents/5xx/wwwdev/503.html';
...
$conf['mcneese_static_file_frontpage'] = '/tmp/static-wwwdev/frontpage.html';
$conf['mcneese_static_file_frontpage-https'] = '/tmp/static-wwwdev/frontpage-https.html';
