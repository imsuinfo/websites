...
if (!defined('DRUPAL_ROOT')) {
  define('DRUPAL_ROOT', '/var/www/drupal/wwwdev2');
}
 ...
 */
$cookie_domain = '.wwwdev2.mcneese.edu';
 ...
 * Temporary directory
 **/
$conf['file_temporary_path'] = '/var/www/webfiles/temporary/wwwdev2';
...
$conf['ip_php_ini']['include_path'] = array('127.0.0.1' => '/var/www/drupal/wwwdev2:/usr/local/lib/php');
 ...
 *  GNU PG Support
 */
putenv('GNUPGHOME=/var/www/drupal/wwwdev2/sites/default/gnupg');
$conf['gpg-mail'] = array(
...
$conf['system_mail_id'] = 'wwwdev2.mcneese.edu';
 ...
 */
if (file_exists(DRUPAL_ROOT . '/sites/default/registry-wwwdev2.php')) {
  include_once DRUPAL_ROOT . '/sites/default/registry-wwwdev2.php';
}
 ...
 * Custom Error Pages
 */
$conf['error_document_file_403'] = '/var/www/error_documents/4xx/wwwdev2/403.html';
$conf['error_document_file_404'] = '/var/www/error_documents/4xx/wwwdev2/404.html';
$conf['error_document_file_500'] = '/var/www/error_documents/5xx/wwwdev2/500.html';
$conf['error_document_file_500-no_database'] = FALSE;
$conf['error_document_file_503'] = '/var/www/error_documents/5xx/wwwdev2/503.html';
...
$conf['mcneese_static_file_frontpage'] = '/tmp/static-wwwdev2/frontpage.html';
$conf['mcneese_static_file_frontpage-https'] = '/tmp/static-wwwdev2/frontpage-https.html';
