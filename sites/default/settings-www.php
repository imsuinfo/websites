...
if (!defined('DRUPAL_ROOT')) {
  define('DRUPAL_ROOT', '/var/www/drupal/www');
}
...
if ($_SERVER['SERVER_PORT'] == 443) {
  $base_url = 'https://www.mcneese.edu';  // NO trailing slash!
}
else {
  $base_url = 'http://www.mcneese.edu';  // NO trailing slash!
}
 ...
 * Temporary directory
 **/
$conf['file_temporary_path'] = '/var/www/webfiles/temporary/www';
...
$conf['ip_php_ini']['include_path'] = array('127.0.0.1' => '/var/www/drupal/www:/usr/local/lib/php');
 ...
 *  GNU PG Support
 */
putenv('GNUPGHOME=/var/www/drupal/www/sites/default/gnupg');
$conf['gpg-mail'] = array(
...
$conf['system_mail_id'] = 'www.mcneese.edu';
 ...
 */
if (file_exists(DRUPAL_ROOT . '/sites/default/registry-www.php')) {
 ...
 * Custom Error Pages
 */
#$conf['error_document_file_403'] = '/var/www/error_documents/4xx/www/403.html';
#$conf['error_document_file_404'] = '/var/www/error_documents/4xx/www/404.html';
#$conf['error_document_file_500'] = '/var/www/error_documents/5xx/www/500.html';
