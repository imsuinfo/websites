 ...
 */
(function($) {
Drupal.behaviors.MsuSlider = {
  attach: function (context) {
    for (id in Drupal.settings.MsuSlider) {
      $('#' + id + ':not(.MsuSlider-processed)', context).addClass('MsuSlider-processed').each(function () {
        var _settings = Drupal.settings.MsuSlider[$(this).attr('id')];
        var nivo = $(this);
        // Fix sizes
