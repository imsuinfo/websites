...
/**
 * @file
 * Default theme implementation to display a single node accessibility statistics plot.
 *
 * Available Variables:
 *
 * Content Variables:
 ...
 * - $plot_rows: An array of rows, each array item contains the following fields:
 *   - machine_name: Machine-friendly name of the row.
 *   - human_name: Human-friendly name of the row.
 *   - link: (optional) A url in which this row will link to.  // #quail_api-test-tablecomplexhassummary
 *   - value: The statistical value in which the row is associated with.
 * - $total_human_name: (optional) Human-friendly name of what the total represents.
 * - $total_value: (optional) The statistical value in which the total is associated with.
 *
 * Styling Variables:
