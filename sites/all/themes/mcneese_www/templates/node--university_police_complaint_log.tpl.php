 ...
 */
  ...
  print('<h3 class="police_complaint_log-item-label police_complaint_log-date-label"><strong>Date:</strong></h3>');
  print('<div class="police_complaint_log-item-value police_complaint_log-date-value">');
  print($police_date);
  print('</div>');
  print('</div>');
