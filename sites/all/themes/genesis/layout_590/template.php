 ...
 *    search/replace on "magazine_layout_3".
...
function magazine_layout_3_preprocess(&$vars, $hook) {
}
function magazine_layout_3_process(&$vars, $hook) {
}
// */
 ...
 */
function magazine_layout_3_preprocess_html(&$vars) {
...
/*
function magazine_layout_3_process_html(&$vars) {
}
//*/
 ...
 */
function magazine_layout_3_preprocess_page(&$vars) {
}
function magazine_layout_3_process_page(&$vars) {
 ...
 */
/* -- Delete this line if you want to use these functions
function magazine_layout_3_preprocess_node(&$vars) {
}
function magazine_layout_3_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function magazine_layout_3_preprocess_comment(&$vars) {
}
function magazine_layout_3_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function magazine_layout_3_preprocess_block(&$vars) {
}
function magazine_layout_3_process_block(&$vars) {
}
// */
