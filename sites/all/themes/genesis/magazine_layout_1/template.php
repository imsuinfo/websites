 ...
 *    search/replace on "magazine_layout_1".
...
function magazine_layout_1_preprocess(&$vars, $hook) {
}
function magazine_layout_1_process(&$vars, $hook) {
}
// */
 ...
 */
function magazine_layout_1_preprocess_html(&$vars) {
...
/*
function magazine_layout_1_process_html(&$vars) {
}
//*/
 ...
 */
function magazine_layout_1_preprocess_page(&$vars) {
}
function magazine_layout_1_process_page(&$vars) {
 ...
 */
/* -- Delete this line if you want to use these functions
function magazine_layout_1_preprocess_node(&$vars) {
}
function magazine_layout_1_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function magazine_layout_1_preprocess_comment(&$vars) {
}
function magazine_layout_1_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function magazine_layout_1_preprocess_block(&$vars) {
}
function magazine_layout_1_process_block(&$vars) {
}
// */
