  ...
  <div id="container" class="drupal-page<?php print($cf['markup_css']['container']['class']); ?>">
    <?php if (!$cf['is']['overlay']){ ?>
      <?php if ($cf['show']['page']['leaderboard']){ ?>
        <div id="leaderboard" class="clearfix">
          <!--(begin_leaderboard)-->
          <?php print($cf['data']['page']['leaderboard']); ?>
          <!--(end_leaderboard)-->
        </div>
      <?php } ?>
      ...
      <?php if ($cf['show']['secondary_menu_links']){ ?>
        <div id="secondary-menu-wrapper" class="clearfix">
          ...
          <div class="secondary-menu-inner"><?php print($cf['data']['secondary_menu_links']); ?></div>
      ...
      <div id="header" class="clearfix">
          ...
          <div id="branding">
            ...
            <?php if ($cf['show']['logo'] || $cf['show']['site_name']){ ?>
              <?php if ($cf['show']['title']){ ?><div class="logo-site-name" style="font-weight: bold;"><?php } else { ?><h1 class="logo-site-name"><?php } ?>
                ...
                <?php } ?>
                <?php if ($cf['show']['site_name']){ ?><span id="site-name"><?php print($cf['data']['site_name']); ?></span><?php } ?>
                <!--(end_site_name)-->
        ...
        <?php if ($cf['show']['page']['header']){ ?>
          <!--(begin_header_blocks)-->
          <div id="header-blocks"><?php print($cf['data']['page']['header']); ?></div>
          <!--(end_header_blocks)-->
        <?php } ?>
    ...
    <?php if ($cf['show']['page']['secondary_content'] && !$cf['is']['overlay']){ ?>
      <div id="secondary-content">
        ...
        <?php print($cf['data']['page']['secondary_content']); ?>
    ...
    <div id="columns" class="clear clearfix <?php print($cf['markup_css']['container']['class']); ?>">
      <?php if ($cf['show']['page']['sidebar_first']){ ?>
        <div id="sidebar-first" class="sidebar">
          <!--(begin_sidebar_first)-->
          <?php print($cf['data']['page']['sidebar_first']); ?>
          <!--(end_sidebar_first)-->
        </div>
      <?php } ?>
      ...
      <div id="content-column">
        ...
        <div class="content-inner">
          <?php if ($cf['show']['page']['highlighted']){ ?>
            <!--(begin_highlighted)-->
            <div id="highlighted"><?php print($cf['data']['page']['highlighted']); ?></div>
            <!--(end_highlighted)-->
          <?php } ?>
      ...
      <?php if ($cf['show']['page']['sidebar_second']){ ?>
        ...
        <div id="sidebar-second" class="sidebar"><?php print($cf['data']['page']['sidebar_second']); ?></div>
        <!--(end_sidebar_second)-->
      <?php } ?>
    </div>
    ...
    <?php if ($cf['show']['page']['tertiary_content'] && !$cf['is']['overlay']){ ?>
      <div id="tertiary-content" class="<?php print($cf['markup_css']['content']['class']); ?>">
        ...
        <?php print($cf['data']['page']['tertiary_content']); ?>
